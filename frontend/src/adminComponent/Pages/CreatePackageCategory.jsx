...
const NewCategoryForm = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            let urls = '/api/packages/insertCategory';
            ...
            if (parentCategoryId && !subCategoryId) {
                urls = `/api/packages/insertSubCategory?categoryId=${parentCategoryId}`;
            } else if (parentCategoryId && subCategoryId) {
                urls = `/api/packages/insertSubSubCategory?categoryId=${parentCategoryId}&subCategoryId=${subCategoryId}`;
            }
