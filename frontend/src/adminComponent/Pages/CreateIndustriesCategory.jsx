...
const NewCategoryForm = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            let urls = '/api/industries/insertCategory';
            ...
            if (parentCategoryId && !subCategoryId) {
                urls = `/api/industries/insertSubCategory?categoryId=${parentCategoryId}`;
            } else if (parentCategoryId && subCategoryId) {
                urls = `/api/industries/insertSubSubCategory?categoryId=${parentCategoryId}&subCategoryId=${subCategoryId}`;
            }
