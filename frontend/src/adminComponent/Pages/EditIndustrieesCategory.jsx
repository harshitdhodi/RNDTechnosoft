  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (categoryId && subCategoryId && subSubCategoryId) {
        urls = `/api/industries/getSpecificSubSubcategory?categoryId=${categoryId}&subCategoryId=${subCategoryId}&subSubCategoryId=${subSubCategoryId}`;
      } else if (categoryId && subCategoryId) {
        urls = `/api/industries/getSpecificSubcategory?categoryId=${categoryId}&subCategoryId=${subCategoryId}`;
      } else if (categoryId) {
        urls = `/api/industries/getSpecificCategory?categoryId=${categoryId}`;
      }
