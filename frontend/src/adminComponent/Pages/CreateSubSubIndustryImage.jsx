...
const NewGalleryForm = () => {
    const { categoryId,subcategoryId, subsubcategoryId} = useParams(); // Get categoryId from URL params
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formData.append('subsubcategoryId', subsubcategoryId); // Use categoryId from URL params

            await axios.post('/api/industryImages/subsub/createGallery', formData, {
                headers: {
