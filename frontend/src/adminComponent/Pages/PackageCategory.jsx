...
const CategoryTable = () => {
  ...
  const deleteCategory = async ({ id }) => {
    try {
      await axios.delete(`/api/packages/deletecategory?id=${id}`, { withCredentials: true });
      fetchCategories();
    } catch (error) {
      console.error(error);
    }
  ...
  const handleStatusChange = async (slug, currentStatus) => {
    ...
    try {
      await axios.put(`/api/packages/updateCategory?categoryId=${slug}`, { status: newStatus }, { withCredentials: true });
      fetchCategories();
    } catch (error) {
      console.error(error);
    }
