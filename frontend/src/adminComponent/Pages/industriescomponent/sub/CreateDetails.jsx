...
const NewIndustriesForm = () => {
  const { categoryId, subcategoryId } = useParams(); // Extract categoryId and subcategoryId from URL
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('/api/industiesDetails/insertSubIndustriesDetail', formData, {
        headers: {
