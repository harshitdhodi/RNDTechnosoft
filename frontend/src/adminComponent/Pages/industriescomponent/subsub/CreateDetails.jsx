...
const NewIndustriesForm = () => {
  const { categoryId, subcategoryId ,subsubcategoryId} = useParams(); // Extract categoryId and subcategoryId from URL
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('subcategoryId', subcategoryId); // Send subcategoryId from URL
      formData.append('subsubcategoryId', subsubcategoryId); // Send subcategoryId from URL
      ...
      await axios.post('/api/industiesDetails/insertSubSubIndustriesDetail', formData, {
        headers: {
