  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const data = response.data.data[2]; // Access the first item in the data array
        setService(data);
    ...
    <div className="flex flex-col items-center">
      ...
      <div className="flex flex-col lg:flex-row  gap-10  lg:px-28  w-full">
        ...
        <div className="w-full lg:w-1/2 px-4 flex flex-col justify-center order-1">
          ...
          <div className="text-4xl font-bold pb-6 overflow-hidden whitespace-nowrap text-ellipsis">
            {service?.heading ? (
              <div
              ...
              <h2 className="overflow-hidden whitespace-nowrap text-ellipsis">Default Heading</h2>
            )}
          </div>
