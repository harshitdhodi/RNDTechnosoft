...
const {updateBlogVisits,getLatestBlogs, insertNews,getNewsFront,getNewsBySlug, getNews, updateNews, deleteNews, getNewsById, countNews, deletePhotoAndAltText, fetchUrlPriorityFreq, editUrlPriorityFreq, fetchUrlPriorityFreqById,fetchUrlmeta, editUrlmeta, fetchUrlmetaById  } = require('../controller/news');
...
router.put('/updateBlogVisits', updateBlogVisits);
